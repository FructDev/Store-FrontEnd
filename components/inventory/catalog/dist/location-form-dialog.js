...
exports.LocationFormDialog = void 0;
...
var switch_1 = require("@/components/ui/switch"); // Para isDefault e isActive
var lucide_react_1 = require("lucide-react");
var react_1 = require("react");
var locationFormSchema = z.object({
    name: z.string().min(2, "Nombre debe tener al menos 2 caracteres.").max(100),
    description: z.string().max(255).optional().nullable(),
    isDefault: z.boolean().optional()["default"](false),
    isActive: z.boolean().optional()["default"](true)
});
function LocationFormDialog(_a) {
    var _this = this;
    var location = _a.location, isOpen = _a.isOpen, onOpenChange = _a.onOpenChange, onSuccess = _a.onSuccess;
    var queryClient = react_query_1.useQueryClient();
    var isEditMode = !!(location === null || location === void 0 ? void 0 : location.id);
    var form = react_hook_form_1.useForm({
        resolver: zod_1.zodResolver(locationFormSchema),
        defaultValues: {
            name: "",
            description: "",
            isDefault: false,
    ...
    var mutation = react_query_1.useMutation({
        mutationFn: function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiData = __assign(__assign({}, data), { description: data.description || null });
                        url = isEditMode && location
        ...
        onSuccess: function (createdOrUpdatedLocation) {
            sonner_1.toast.success("Ubicaci\u00F3n \"" + createdOrUpdatedLocation.name + "\" " + (isEditMode ? "actualizada" : "creada") + " correctamente.");
    ...
    return (react_1["default"].createElement(dialog_1.Dialog, { open: isOpen, onOpenChange: onOpenChange },
        react_1["default"].createElement(dialog_1.DialogContent, { className: "sm:max-w-md" },
            react_1["default"].createElement(dialog_1.DialogHeader, null,
                react_1["default"].createElement(dialog_1.DialogTitle, null, isEditMode ? "Editar Ubicación" : "Crear Nueva Ubicación"),
                ...
                react_1["default"].createElement("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-4 py-4" },
                    react_1["default"].createElement(form_1.FormField, { control: form.control, name: "name", render: function (_a) {
                            ...
                            return (react_1["default"].createElement(form_1.FormItem, null,
                                react_1["default"].createElement(form_1.FormLabel, null, "Nombre de la Ubicaci\u00F3n"),
                                react_1["default"].createElement(form_1.FormControl, null,
                                    react_1["default"].createElement(input_1.Input, __assign({ placeholder: "Ej: Almac\u00E9n Principal, Vitrina 1" }, field))),
                    ...
                    react_1["default"].createElement(form_1.FormField, { control: form.control, name: "description", render: function (_a) {
                            ...
                            return (react_1["default"].createElement(form_1.FormItem, null,
                                ...
                                react_1["default"].createElement(form_1.FormControl, null,
                                    react_1["default"].createElement(textarea_1.Textarea, __assign({ placeholder: "Detalles adicionales sobre la ubicaci\u00F3n" }, field, { value: (_b = field.value) !== null && _b !== void 0 ? _b : "" }))),
                                react_1["default"].createElement(form_1.FormMessage, null)));
                        } }),
                    react_1["default"].createElement(form_1.FormField, { control: form.control, name: "isDefault", render: function (_a) {
                            var field = _a.field;
                            return (react_1["default"].createElement(form_1.FormItem, { className: "flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm" },
                                react_1["default"].createElement("div", { className: "space-y-0.5" },
                                    react_1["default"].createElement(form_1.FormLabel, null, "Ubicaci\u00F3n por Defecto"),
                                    react_1["default"].createElement(form_1.FormDescription, null, "Marcar si es la ubicaci\u00F3n principal o por defecto.")),
                                react_1["default"].createElement(form_1.FormControl, null,
                    ...
                    react_1["default"].createElement(form_1.FormField, { control: form.control, name: "isActive", render: function (_a) {
                            ...
                            return (react_1["default"].createElement(form_1.FormItem, { className: "flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm" },
                                react_1["default"].createElement("div", { className: "space-y-0.5" },
                                    react_1["default"].createElement(form_1.FormLabel, null, "Activa"),
                                    react_1["default"].createElement(form_1.FormDescription, null, "Permitir usar esta ubicaci\u00F3n para stock.")),
                                react_1["default"].createElement(form_1.FormControl, null,
                                    react_1["default"].createElement(switch_1.Switch, { checked: field.value, onCheckedChange: field.onChange }))));
                        } }),
...
exports.LocationFormDialog = LocationFormDialog;
