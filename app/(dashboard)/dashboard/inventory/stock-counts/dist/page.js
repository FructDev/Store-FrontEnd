...
var date_range_picker_1 = require("@/components/ui/date-range-picker"); // Asumiendo que lo tienes
...
var create_stock_count_dialog_1 = require("@/components/inventory/stock-counts/create-stock-count-dialog");
...
function StockCountsPage() {
    ...
    var _f = react_1.useState("all"), filterUserId = _f[0], setFilterUserId = _f[1];
    ...
    }), locations = _j.data, isLoadingLocations = _j.isLoading;
    ...
    }), users = _k.data, isLoadingUsers = _k.isLoading;
    ...
    }), paginatedData = _l.data, isLoading = _l.isLoading, isError = _l.isError, error = _l.error, isFetching = _l.isFetching;
    ...
    var navigateToDetail = function (id) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(page_header_1.PageHeader, { title: "Conteos F\u00EDsicos de Stock", description: "Inicia, gestiona y finaliza los conteos de tu inventario f\u00EDsico.", actionButton: react_1["default"].createElement(button_1.Button, { onClick: function () { return setIsCreateDialogOpen(true); } },
        ...
        react_1["default"].createElement(card_1.Card, { className: "mb-6" },
            react_1["default"].createElement(card_1.CardHeader, { className: "flex flex-row items-center justify-between" },
                react_1["default"].createElement(card_1.CardTitle, { className: "text-lg flex items-center" },
                    ...
                    "Filtros"),
                react_1["default"].createElement(button_1.Button, { variant: "ghost", onClick: clearFilters, size: "sm", className: "text-sm" },
            ...
            react_1["default"].createElement(card_1.CardContent, null,
                react_1["default"].createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 gap-4 items-end" },
                    react_1["default"].createElement("div", { className: "relative" },
                        ...
                        react_1["default"].createElement(input_1.Input, { type: "search", placeholder: "Buscar por N\u00BA, Notas...", value: searchTerm, onChange: function (e) { return setSearchTerm(e.target.value); }, className: "pl-10" })),
                    ...
                    react_1["default"].createElement(select_1.Select, { value: filterLocationId, onValueChange: setFilterLocationId, disabled: isLoadingLocations },
                        react_1["default"].createElement(select_1.SelectTrigger, null,
                    ...
                    react_1["default"].createElement(select_1.Select, { value: filterUserId, onValueChange: setFilterUserId, disabled: isLoadingUsers },
                        react_1["default"].createElement(select_1.SelectTrigger, null,
                            react_1["default"].createElement(select_1.SelectValue, { placeholder: "Iniciado por..." })),
                        react_1["default"].createElement(select_1.SelectContent, null,
                            react_1["default"].createElement(select_1.SelectItem, { value: "all" }, "Todos los Usuarios"),
                            isLoadingUsers && (react_1["default"].createElement(select_1.SelectItem, { value: "loading-usr", disabled: true }, "Cargando...")), users === null || users === void 0 ? void 0 :
                            users.map(function (usr) { return (react_1["default"].createElement(select_1.SelectItem, { key: usr.id, value: usr.id },
                                usr.firstName,
                                " ",
                                usr.lastName)); }))),
                    react_1["default"].createElement("div", null,
                        react_1["default"].createElement("p", { className: "text-sm font-medium mb-1.5" }, "Rango de Fechas (Iniciado)"),
                    ...
                    react_1["default"].createElement(table_1.TableBody, null, isLoading || (isFetching && !(paginatedData === null || paginatedData === void 0 ? void 0 : paginatedData.data)) ? (__spreadArrays(Array(limitPerPage)).map(function (_, i) { return (react_1["default"].createElement(table_1.TableRow, { key: "skel-sc-" + i }, __spreadArrays(Array(7)).map(function (_, j) { return (react_1["default"].createElement(table_1.TableCell, { key: j },
                        ...
                        return (react_1["default"].createElement(table_1.TableRow, { key: sc.id },
                            ...
                            react_1["default"].createElement(table_1.TableCell, null,
                                ((_b = sc.user) === null || _b === void 0 ? void 0 : _b.firstName) || "",
                                " ",
                            ...
                            react_1["default"].createElement(table_1.TableCell, null,
                                react_1["default"].createElement(badge_1.Badge, { variant: sc.status === prisma_enums_1.StockCountStatus.COMPLETED
                                        ? "default"
                                        : sc.status === prisma_enums_1.StockCountStatus.CANCELLED
                                            ? "destructive"
                                            : "outline", className: sc.status === prisma_enums_1.StockCountStatus.COMPLETED
                                        ? "bg-green-100 text-green-700 hover:bg-green-200"
                                        : "" }, statusLabels[sc.status] ||
                                    sc.status)),
                            react_1["default"].createElement(table_1.TableCell, { className: "text-right" },
                                react_1["default"].createElement(button_1.Button, { variant: "outline", size: "sm", onClick: function () { return navigateToDetail(sc.id); } }, sc.status === prisma_enums_1.StockCountStatus.PENDING ||
                        ...
                        react_1["default"].createElement(table_1.TableCell, { colSpan: 7, className: "text-center py-10" }, "No se encontraron sesiones de conteo con los filtros actuales."))))))),
        ...
        react_1["default"].createElement(create_stock_count_dialog_1.CreateStockCountDialog, { isOpen: isCreateDialogOpen, onOpenChange: setIsCreateDialogOpen, onSuccess: function (newStockCountId) {
